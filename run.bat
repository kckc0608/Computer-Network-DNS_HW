...
@REM start "root_DNS" python rootDNSserver.py 23003
start "root_DNS" python rootDNSserver2.py 23003
@REM start "com TLD DNS" python comTLDDNSserver.py 23004
start "com TLD DNS" python comTLDDNSserver2.py 23004
